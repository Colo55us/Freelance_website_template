...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="images/sleeveless/img1.jpg" class="items" height="150"alt="" />
			...
			<li id="2">
				<img src="images/sleeveless/img2.jpg" class="items" height="150" alt="" />
			...
			<li id="3">
				<img src="images/sleeveless/img3.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Peach color suit</div>
			</li>
			<li id="4">
				<img src="images/sleeveless/img4.jpg" class="items" height="150" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="images/sleeveless/img1.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Blue anarkali suit perfect for summer collection
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="images/sleeveless/img2.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Long blue suit with beautiful work by hand
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="images/sleeveless/img3.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						peach color suit perfect for every ocassion.
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="images/sleeveless/img4.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Purple suit with elegant stylish look.
