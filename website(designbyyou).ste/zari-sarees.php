...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="images/zari-sarees/img1.jpg" class="items" height="150"alt="" />
				
				<br clear="all" />
				<div>Magenta zari saree</div>
			</li>
			
			<li id="2">
				<img src="images/zari-sarees/img2.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>red and creme zari saree</div>
			</li>
			
			<li id="3">
				<img src="images/zari-sarees/img3.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Dark brown zari saree</div>
			</li>
			<li id="4">
				<img src="images/zari-sarees/img4.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Purple zari saree </div>
			</li>
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="images/zari-sarees/img1.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>magenta zari saree</label>
					<br clear="all" />
					
					<p>
						elegant Magenta zari saree for every eve. 
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="images/zari-sarees/img2.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Designer red and creme zari saree with beautiful work by hand
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="images/zari-sarees/img3.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Dark brown zari saree perfect for every ocassion.
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="images/zari-sarees/img4.jpg" class="detail_images" width="340" height="310" alt="" />
				...
				<div class="detail_info">
					...
					<p>
						Purple zari saree with polka dots pattern.
			...
			<li id="5">
				<img src="images/zari-sarees/img5.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Black zari saree</div>
			</li>
			
			<li id="6">
				<img src="images/zari-sarees/img6.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Navy blue zari saree</div>
			</li>
			
			<li id="7">
				<img src="images/zari-sarees/img7.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Net zari saree</div>
			</li>
			<li id="8">
				<img src="images/zari-sarees/img8.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Maroon zari saree</div>
			</li>
			...
			<div class="detail-view" id="detail-5">
				...
				<img src="images/zari-sarees/img5.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Black zari saree</label>
					<br clear="all" />
					
					<p>
						Black zari saree with beautiful zari work
			...
			<div class="detail-view" id="detail-6">
				...
				<img src="images/zari-sarees/img6.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Navy blue zari saree</label>
					<br clear="all" />
					
					<p>
						Navy blue zari saree with beautiful pattern
			...
			<div class="detail-view" id="detail-7">
				...
				<img src="images/zari-sarees/img7.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Net zari saree</label>
					<br clear="all" />
					
					<p>
						Net zari saree with full embroidered top .
			...
			<div class="detail-view" id="detail-8">
				...
				<img src="images/zari-sarees/img8.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Maroon zari saree</label>
					<br clear="all" />
					
					<p>
							Maroon zari saree with elegant design			
						<br clear="all" /><br clear="all" />
						Rs-<span class="price">1000</span>
