...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="images/wedding gown/img1.jpg" class="items" height="150"alt="" />
				
				<br clear="all" />
				<div>Wedding gown 1</div>
			</li>
			
			<li id="2">
				<img src="images/wedding gown/img2.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Wedding gown 2</div>
			</li>
			
			<li id="3">
				<img src="images/wedding gown/img3.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Wedding gown 3</div>
			</li>
			<li id="4">
				<img src="images/wedding gown/img4.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Wedding gown 4</div>
			</li>
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="images/wedding gown/img1.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Wedding gown 1</label>
					<br clear="all" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="images/wedding gown/img2.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Wedding gown 2</label>
					<br clear="all" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="images/wedding gown/img3.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Wedding gown 3</label>
					<br clear="all" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="images/wedding gown/img4.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Wedding gown 4</label>
					<br clear="all" />
