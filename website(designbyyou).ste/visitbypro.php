  ...
  <div id="top-right" class="linkprop">
	...
	<div id="top-nav">
	 ...
	 <!-- InstanceBeginEditable name="content" -->
    	...
    	<div id="visitbypro">
            <br>
        	<h2 class="textalign">GET VISITED BY PROFESSIONAL</h2><br>
            <h3 class="textalign">Share you imagination about your design with our professional at your home</h3>
            <br>
            <br>
            <div id="visitbypro2">
            <form action="#" method="post">
            <table>
            <tr><td><b>Full Name :</b></td><td><input type="text" name="provisit-name"></td></tr>
            <tr><td><b>Address :</b></td><td><input type="text" name="provisit-add"></td></tr><br>
            <tr><td><b>Date :</b></td><td><input type="date" name="provisit-date"></td></tr><br>
            <tr><td><b>Time :</b></td><td><input type="time" name="provisit-time"></td></tr><br>
            <tr><td><b>Purpose :</b></td><td><textarea name="provisit-purose" rows="6"></textarea></td></tr><br>
            </table>
            <br>
            <input type="submit"> 
