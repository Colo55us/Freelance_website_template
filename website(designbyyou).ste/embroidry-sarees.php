...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="images/embroidery-sarees/img1.jpg" class="items" height="150"alt="" />
				
				<br clear="all" />
				<div>Red and white saree</div>
			</li>
			
			<li id="2">
				<img src="images/embroidery-sarees/img2.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Blue and white saree</div>
			</li>
			
			<li id="3">
				<img src="images/embroidery-sarees/img3.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Bridal red saree</div>
			</li>
			<li id="4">
				<img src="images/embroidery-sarees/img4.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Bridal orange saree</div>
			</li>
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="images/embroidery-sarees/img1.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Red and white saree</label>
					<br clear="all" />
					
					<p>
						Red and white saree perfect for summer collection
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="images/embroidery-sarees/img2.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Blue and white saree</label>
					<br clear="all" />
					
					<p>
						Blue and white saree with beautiful work by hand
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="images/embroidery-sarees/img3.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Bridal red saree</label>
					<br clear="all" />
					

					<p>
						Bridal red saree perfect for every ocassion.
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="images/embroidery-sarees/img4.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Bridal orange saree</label>
					<br clear="all" />
					
					<p>
						Bridal orange saree with polka dots pattern.
			...
			<li id="5">
				<img src="images/embroidery-sarees/img5.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Lime green saree</div>
			</li>
			
			<li id="6">
				<img src="images/embroidery-sarees/img6.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Embroidered white saree</div>
			</li>
			
			<li id="7">
				<img src="images/embroidery-sarees/img7.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Bridal pink saree</div>
			</li>
			<li id="8">
				<img src="images/embroidery-sarees/img8.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Black and creme saree</div>
			</li>
			...
			<div class="detail-view" id="detail-5">
				...
				<img src="images/embroidery-sarees/img5.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Lime green saree</label>
					<br clear="all" />
					
					<p>
						LIme green saree with beautiful zari work
			...
			<div class="detail-view" id="detail-6">
				...
				<img src="images/embroidery-sarees/img6.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Embroidered white saree</label>
					<br clear="all" />
					
					<p>
						Embroidered white saree with beautiful pattern
			...
			<div class="detail-view" id="detail-7">
				...
				<img src="images/embroidery-sarees/img7.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Bridal pink saree</label>
					<br clear="all" />
					
					<p>
						Bridal pink saree with full embroidered top  
			...
			<div class="detail-view" id="detail-8">
				...
				<img src="images/embroidery-sarees/img8.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Black and creme saree</label>
					<br clear="all" />
					
					<p>
							Black and creme saree with elegant design			
						<br clear="all" /><br clear="all" />
						Rs-<span class="price">1000</span>
