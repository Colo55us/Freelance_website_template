...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <div id="whyus">
       <p><h2>DesignByYou</h2> truly believes that a unique wardrobe should be accessible to everyone.<br>
           Our mission is simple: to give people the freedom to choose their own style and reveal their personality through           their outfit. Every day. At an affordable price.<br>
           <br>
           The <b>main benefit</b> of a custom garment is it fits you like a glove. You can forget about sizes, since you           only need to undergo the measuring process once.<br>When your dress has a perfect fit, your next one can be           manufactured with finished hems and sleeves, eliminating the need for alterations.
		   <br><br>
           When creating a custom wardrobe, you can personalize everything from the choice of fabric, to the buttons and           pockets style, lining color, and even lapel width.<br>
