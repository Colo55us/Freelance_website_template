...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <div id = "contact">
    	<h2 class="textalign">Head office</h2>
        <p class="textalign">23-29 , 2nd floor , main corporate park</p>
        <p class="textalign">Sec-20 , Metro city</p>
        <p class="textalign">122002</p><br>
        <p class="textalign">For 	any queries , feel free to call toll free number-</p>
        <p class="textalign">011-123456,57,58</p>
        <p class="textalign">or mail at :- contact@designbyyou.com</p>
