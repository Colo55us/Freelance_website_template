...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <div id="fabricsample">
      <h2>ORDER FABRIC SAMPLE</h2>
      <div id="visitbypro2">
      		<h2>This username doesn't exist, please enter the correct username</h2>
            <form action="orderfabric(backend).php" method="post"  name="fabricform" onSubmit="return validateform()">
            <table>
            <tr><td><b>Username :</b></td><td><input type="text" name="fabric_uname" required></td></tr>
            <tr><td><b>Address :</b></td><td><input type="text" name="fabricsample_add" required></td></tr><br>
            <tr><td><b>Select Fabric Type</b></td>
