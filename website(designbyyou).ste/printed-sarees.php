...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="images/printed sarees/img1.jpg" class="items" height="150"alt="" />
				
				<br clear="all" />
				<div>Black and purple saree</div>
			</li>
			
			<li id="2">
				<img src="images/printed sarees/img2.jpg" class="items" height="150" alt="" />
			...
			<li id="3">
				<img src="images/printed sarees/img3.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Pink Saree</div>
			</li>
			<li id="4">
				<img src="images/printed sarees/img4.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Orange and pink saree</div>
			</li>
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="images/printed sarees/img1.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Black and purple saree</label>
					<br clear="all" />
					
					<p>
						Designer Black and purple saree perfect for summer collection
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="images/printed sarees/img2.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Designer Blue Saree</label>
					<br clear="all" />
					
					<p>
						Designer Blue saree with beautiful work by hand
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="images/printed sarees/img3.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>pink Saree</label>
					<br clear="all" />
					

					<p>
						Pink saree suit perfect for every ocassion.
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="images/printed sarees/img4.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Orange and pink saree</label>
					<br clear="all" />
					
					<p>
						Orange and pink saree with polka dots pattern.
			...
			<li id="5">
				<img src="images/printed sarees/img5.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Pink and creme saree</div>
			</li>
			
			<li id="6">
				<img src="images/printed sarees/img6.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Printed yellow saree</div>
			</li>
			
			<li id="7">
				<img src="images/printed sarees/img7.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Green saree</div>
			</li>
			<li id="8">
				<img src="images/printed sarees/img8.jpg" class="items" height="150" alt="" />
			...
			<div class="detail-view" id="detail-5">
				...
				<img src="images/printed sarees/img5.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Pink and creme saree</label>
					<br clear="all" />
					
					<p>
						Pink and creme saree with beautiful zari work
			...
			<div class="detail-view" id="detail-6">
				...
				<img src="images/printed sarees/img6.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>PRinted yellow saree</label>
					<br clear="all" />
					
					<p>
						Printed yellow saree with beautiful pattern
			...
			<div class="detail-view" id="detail-7">
				...
				<img src="images/printed sarees/img7.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>green saree</label>
					<br clear="all" />
			...
			<div class="detail-view" id="detail-8">
				...
				<img src="images/printed sarees/img8.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Black Saree</label>
					<br clear="all" />
					
					<p>
							Black saree with elegant design			
						<br clear="all" /><br clear="all" />
						Rs-<span class="price">1000</span>
			...
			<li id="9">
				<img src="images/printed sarees/img9.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div><span class="name">Printed white saree</span><span class="price"></span></div>
			</li>
			
			<li id="10">
				<img src="images/printed sarees/img10.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div><span class="name">White and black saree </span> </div>
			</li>
			
			<li id="11">
				<img src="images/printed sarees/img11.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div>Purple saree</div>
			</li>
			
			<li id="12">
				<img src="images/printed sarees/img12.jpg" class="items" height="150" alt="" />
				
				<br clear="all" />
				<div><span class="name">maroon saree</span> Shirt </div>
			</li>
			...
			<div class="detail-view" id="detail-9">
				...
				<img src="images/printed sarees/img9.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Printed white saree</label>
					<br clear="all" />
					
					<p>
						Printed white saree with elegant and sober design
			...
			<div class="detail-view" id="detail-10">
				...
				<img src="images/printed sarees/img10.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Black and white saree</label>
					<br clear="all" />
					
					<p>
						Black and white saree perfect for every occasion
			...
			<div class="detail-view" id="detail-11">
				...
				<img src="images/printed sarees/img11.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>Purple saree</label>
					<br clear="all" />
					
					<p>
						Purple saree with beautiful pattern
			...
			<div class="detail-view" id="detail-12">
				...
				<img src="images/printed sarees/img12.jpg" class="detail_images" width="340" height="310" alt="" />
				
				<div class="detail_info">
					
					<label class='item_name'>MAroon saree</label>
					<br clear="all" />
					
					<p>
						MAroon saree with all beautiful hand work
