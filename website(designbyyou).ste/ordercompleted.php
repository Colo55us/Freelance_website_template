...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <h1 class="textalign">Congo! Order Placed Successfully</h1>
    <h3 class="textalign">We will let you know once your order has been screened , passed and is ready to be made</h3>
    <h4 class="textalign"><a href="index.php">Click here! </a> to go to home page</h4> 
    </div>
