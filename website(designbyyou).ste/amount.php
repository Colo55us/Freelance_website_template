...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <?php
     ...
     $totalCharges=$_POST["total-hidden-charges"];

      $user_check=$_SESSION['login_user'];
      $_SESSION['grandTotal']=$totalCharges;
	  $connection=mysqli_connect("localhost","root","","customer") or die("Unable to connect to database");
      $result=mysqli_query($connection,"select * from customer_info where username='$user_check'") 
              or die ("unable to fetch result"); 
      $compare = mysqli_fetch_array($result); 
      
      ?>
      
     <h1 class="textalign"><u><?php echo ($user_check); ?>'s Shopping Cart</u></h1>
     
  
        <table align="center">
        	<tr>
        		<td><b> Order No.</b> </td><td><?php echo(rand(10,100)); ?></td>
            </tr>
            <tr>
            	<td><b> Customer name</b> </td><td><?php echo($compare['Name']) ?></td>
            </tr>
            <tr>
                <td><b> Postal Address</b> </td><td><?php echo($compare['Address']) ?></td>
            </tr>
            <tr>
                <td><b> E-mail I.D.</b> </td><td><?php echo($compare['email']) ?></td>
             </tr>
             <tr>
            	<td><b> Total Amount </b></td><td><?php echo($totalCharges) ?></td>
            </tr>
        </table>
        <a href="checkout.php"><h3 class="textalign">Click here to Check-Out!!</h3></a>
         <div id="coupon">
    Have any coupon<br>
