...
<title>DesignByYou-Get Started</title>
<!-- InstanceEndEditable -->
  ...
  <div id="top-right" class="linkprop">
	...
	<div id="top-nav">
	 ...
	 <!-- InstanceBeginEditable name="content" -->
    	...
    	<div id="imgupload">
           <h1 class="textalign">GET STARTED</h1>
           <h2 class="textalign">Select different design patterns for the customisation of dress</h2><br>
           <form method="post" action="getstarted(backend).php">
           <table>
              <tr>
              ...
              <tr>
                <td><b>Select the type of dress</b></td>
              ...
              <tr>
                <td><b>Enter design pattern 1-</b></td>
                <td><input type="file" name="design_upload1" accept="image/jpeg" required></td>
              </tr> 
              <tr>
                <td><b>Enter design pattern 2-</b></td>
                <td><input type="file" name="design_upload2" accept="image/jpeg"></td>
              </tr> 
              <tr>
                <td><b>Enter design pattern 3-</b></td>
                <td><input type="file" name="design_upload3" accept="image/jpeg"></td>
              </tr>
              <tr>
                <td><b>Select fabric</b></td>
                <td><input type="radio" name="fabric" value="cotton" required>Cotton
                    <input type="radio" name="fabric" value="silk" required>Silk
                    <input type="radio" name="fabric" value="zari" required>Zari
                    <input type="radio" name="fabric" value="pashmina" required>Pashmina
                </td>
              </tr>
              <tr>
                <td><b>Select Base color</b></td>
                <td><input type="color" name="color1"> *<small>optional</small></td>
              </tr>
           </table>
             <input type="submit"> 
