...
<div id="top-logo">
  ...
  <div id="top-right" class="linkprop">
    ...
    <div class="textalign"><br><br><br>
    <?php
      
      $username_c=$_SESSION['login_user'];
      $amount_c=$_SESSION['grandTotal'];
	  date_default_timezone_set('Asia/Calcutta');
      $date1 = date('Y-m-d h:i:s');
      $connection=mysqli_connect("localhost","root","","customer") or die("Unable to connect to database");
      $insert = "insert into user_payments(username,order_amount,date) values('$username_c','$amount_c','$date1')";
	  if(mysqli_query($connection,$insert))
	  {echo('order completed and the item(s) will be dispatched and will reach to you within a week on your address ');}
	  else
	  {echo ("Internal problem occured ..please try again in a moment");}
    ?>
    <a href="logout.php"><h2 class="textalign">SIGNOUT</h2></a>
    </div><br><br><br><br>
        <!-- InstanceEndEditable -->
        <div id="footer-left">
