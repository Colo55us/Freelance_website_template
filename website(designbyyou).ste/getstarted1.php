	...
	<div id="top-nav">
	 ...
	 <!-- InstanceBeginEditable name="content" -->
    	...
    	<div id="imgupload">
           ...
           <h2 class="textalign">Oops! Something went wrong .Please fill the form again</h2><br>
           ...
           <table>
              ...
              <tr>
                ...
                <td><input type="file" name="design_upload1" accept="image/jpeg"></td>
              </tr> 
              <tr>
              ...
              <tr>
                ...
                <td><input type="radio" name="fabric" value="cotton">Cotton
                    <input type="radio" name="fabric" value="silk">Silk
                    <input type="radio" name="fabric" value="zari">Zari
                    <input type="radio" name="fabric" value="pashmina">Pashmina
                </td>
              </tr>
              <tr>
